...
import { CacheObjectMetadata, DecisionRecord, DecisionType, ScoreFactors, SystemSettings } from '../types';
...
export class LifecycleEngine {
  ...
  public evaluate(
  ...
  ): { decision: DecisionType; newTtlSeconds: number; reason: string; decisionRecord: DecisionRecord } {
    ...
    let decision: DecisionType = 'KEEP';
    let reason = '';
...
export const lifecycle = new LifecycleEngine();
