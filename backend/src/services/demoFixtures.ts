...
export interface DemoFixtureObject {
  objectId: string;
  price: number;
  demand: number;
  sizeBytes: number;
...
export const DEMO_FIXTURES: Record<string, DemoFixtureObject> = {
  'DEMO-001': {
    objectId: 'DEMO-001',
    price: 500,
    demand: 100,
...
export const DEMO_SCENARIOS: Record<DemoScenarioType, DemoScenarioDefinition> = {
  BASIC_CACHE: {
    id: 'BASIC_CACHE',
