/**
 * What-If Scenario Analysis Page (Warm Tech Theme)
    ...
    <div className="p-6 space-y-6 max-w-[1600px] mx-auto animate-fadeIn">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={isApplying}
          className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-stone-950 font-extrabold text-xs font-mono rounded-xl shadow-lg shadow-amber-500/20 transition-all cursor-pointer shrink-0"
        >
      ...
      {appliedMessage && (
        <div className="p-3 bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs font-mono rounded-xl animate-fadeIn">
          ✓ {appliedMessage}
        </div>
      )}
        ...
        <div className="bg-dark-900 border border-dark-750 rounded-xl p-5 shadow-sm space-y-5 font-mono text-xs">
          ...
          <div>
            <div className="flex justify-between text-stone-300 mb-1.5">
              ...
              <span className="text-orange-400 font-bold">{trafficMultiplier.toFixed(1)}x</span>
            </div>
                ...
                <button
                  ...
                  className={`py-1 rounded text-[11px] border transition-colors ${
                    trafficMultiplier === m
                      ...
                      : 'bg-dark-850 border-dark-700 text-stone-400 hover:text-stone-200'
                  }`}
                >
                  {m}x
                </button>
            ...
            <div className="grid grid-cols-4 gap-1.5 mb-2">
              {[64, 128, 512, 1024].map((c) => (
                <button
                  ...
                  className={`py-1 rounded text-[11px] border transition-colors ${
                    cacheCapacityMb === c
                      ? 'bg-brand-emerald text-stone-950 border-brand-emerald font-bold'
                      : 'bg-dark-850 border-dark-700 text-stone-400 hover:text-stone-200'
                  }`}
                >
                  {c >= 1024 ? '1 GB' : `${c} MB`}
        ...
        <div className="lg:col-span-2 space-y-4 font-mono">
          <div className="bg-dark-900 border border-dark-750 rounded-xl p-5 shadow-sm space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-dark-750">
              ...
              <span className="text-[10px] text-amber-300 bg-amber-500/10 px-2.5 py-0.5 rounded-lg border border-amber-500/20">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-dark-850 p-4 rounded-xl border border-dark-700 flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <div className="text-[11px] text-stone-400">Current: {(comparison.current.hitRate * 100).toFixed(1)}%</div>
                  </div>
                ...
                <div className="bg-dark-850 p-4 rounded-xl border border-dark-700 flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <div className="text-[11px] text-stone-400">Current: {comparison.current.avgLatencyMs} ms</div>
                  </div>
                  <div className="text-right">
                ...
                <div className="bg-dark-850 p-4 rounded-xl border border-dark-700 flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <div className="text-[11px] text-stone-400">Current: {(comparison.current.backendLoadRatio * 100).toFixed(1)}%</div>
                  </div>
                  <div className="text-right">
                ...
                <div className="bg-dark-850 p-4 rounded-xl border border-dark-700 flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <div className="text-[11px] text-stone-400">Current: ${comparison.current.costPerHourUsd.toFixed(3)}</div>
                  </div>
                  <div className="text-right">
                    <div className="text-lg font-bold text-amber-400">
